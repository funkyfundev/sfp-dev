...
class VboxCommand extends Command
{
    ...
    protected function configure()
    {
        $this->setName('dev')
            ...
            ->addArgument('action', InputArgument::REQUIRED, 'Required action for dev machine. <info>[stop, start, status, restart, list-actions]</info>');
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if(!in_array($action, [self::VBOX_STATUS, self::VBOX_STOP, self::VBOX_START, self::VBOX_RESTART, self::LIST_ACTIONS])) {
